...
class Net(models.GoogLeNet):
    def __init__(
        ...
        super().__init__(num_classes=num_classes,init_weights=init_weights)
        self.num_classes = num_classes
        # self.conv1 = BasicConv2d(1, 64, kernel_size=7, stride=2, padding=3)
        # self.maxpool1 = nn.MaxPool2d(1, stride=2, ceil_mode=True)

    def forward(self, x):
        output = super().forward(x)
        o1 = torch.nn.functional.softmax(output[0], dim=0)
        return o1

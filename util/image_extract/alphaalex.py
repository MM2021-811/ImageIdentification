...
from util.trainingutil import AlphaWeightedAlexNet,AlphaBgTransform
...
class BaseModel(object):
    ...
    def load_model(self):
        ...
        self.model = AlphaWeightedAlexNet(device=self.device) 
    ...
    def preprocess_input(self, image):
        # input image should cv2 RGB or RGBA images

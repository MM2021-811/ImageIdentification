...
class VearchUtil:
    ...
    def add_image_index(self, image_name: str, sid: str, keyword: str, tags: list = [], uuid: str = None):
        ...
        url = f"{self.server_url}/foods/foods/{uuid}"
        # logger.debug(url)
    ...
    def search_by_image(self, keyword: str, image = None, feature: list = None) -> dict:
        """[summary]            
        Args:
        ...
        url = f"{self.server_url}/foods/foods/_search?size=10"

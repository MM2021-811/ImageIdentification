...
def main():
    ...
    #     "../data", train=True, download=True, transform=tranform_train
    # )    
    # dataset2 = datasets.CIFAR100("../data", train=False, transform=tranform_test)
    dataset1 = datasets.CIFAR10(
        "../data", train=True, download=True, transform=tranform_train
    )    
    dataset2 = datasets.CIFAR10("../data", train=False, transform=tranform_test)
    ...
    model = models.alexnet(pretrained=False, num_classes=10).to(device)
    ...
    checkpoint_model = f"./models/CIFAR10_AlexNet.pt"
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        scheduler.step()
        if args.save_model and best_accuracy < accuracy:
